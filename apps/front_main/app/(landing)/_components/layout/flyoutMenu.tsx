...
export const FlyoutMenu = () => (
  <Container>
    ...
    <StyledHr />
    <Link href="/product/page1" legacyBehavior>
      <a>
        <Item>
          <MenuImageWrapper>
            <StyledIconBullish />
    ...
    <Link href="/product/page2" legacyBehavior>
      <a>
        <Item>
          <MenuImageWrapper>
            <StyledIconInvite />
    ...
    <Link href="/product/page3" legacyBehavior>
      <a>
        <Item>
          <MenuImageWrapper>
            <StyledIconTasks />
    ...
    <Link href="/product/page4" legacyBehavior>
      <a>
        <Item>
          <MenuImageWrapper>
            <StyledTimeline />
